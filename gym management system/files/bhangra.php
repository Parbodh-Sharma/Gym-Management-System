...
<body>
    ...
    <div class="mid">
    <div class="pic">
        <img src="images/Bhangra-Classes.jpeg" alt="">
    </div>
...
<li> 
   ...
   <li><pre>Wednesday                  5:00 am - 10:00 pm 
       ...
       <li><pre>Saturday                      5:00 am - 10:00 pm 
        ...
        <div class="about">
            <h2> ABOUT THE BHANGRA CLASSES </h2>
            <p>
                <br>
                Happy feet will do the Bhangra – are you joining? The traditional dance of enthusiastic Punjabi people – Bhangra – is fast emerging as the best fitness workout all across the globe. No wonder, there has been regular Bhangra classes throughout the week at our fitness club.
            </p>
            <p><b><br>Energy, Fun & Passion – that’s what you will experience in Muscle-Farm Bhangra Classes!</b></p>
            <p><br>
                All the moves in the program follow the folk dance pattern, but have been reconditioned so that they can also provide a healthy cardiovascular program, designed to burn as many as 500 calories an hour. The best part – there won’t be any better cardio workout than this! Take a class and you will certainly get this fact testified by your sore muscles and muscle cramps the next day. So you have the energy and passion to go crazy? !
            </p>
            <p><br>
                The <b>45-min class </b>starts with some of the best and pulsating Punjabi numbers. Even if you are a new-comer, you will let loose in the foot-tapping crazy-going Punjabi music. You will be surprised with the adrenalin rush within you and the innate energy that oozes out from you. Simply have a look at your partners around and everyone is sweating and competing; the positive vibes of the class leaves you on an all-time high emotional and physical energy level. That’s the kind of unique aura you can experience at <b>Muscle-Farm Bhangra Class. </b>
            </p>
            ...
            <ul>
<br>
   <li> Most entertaining workout regime</li>
 <li>   Improved metabolism and fitness</li>
  <li>  High cardio session with core muscles workout as well </li>
 <li>   Heart pumping workout </li>
   <li> Lose weight and tone up </li>
 <li>   Great workout for arms and shoulders as well</li>
 <li>   Learn to be showstopper in parties through these classes</li>
</ul>
